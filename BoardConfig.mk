...
TARGET_PREBUILT_KERNEL := device/samsung/hltecan/zImage
TARGET_PREBUILT_DTB := device/samsung/hltecan/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/hltecan/bootimg.mk
